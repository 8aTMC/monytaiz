...
import { Zap, Upload, Clock, HardDrive } from 'lucide-react';
  ...
  return (
    <Card className={`p-4 transition-all duration-300 ${isActive ? 'ring-2 ring-primary' : ''}`}>
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground capitalize">{progress.phase}</p>
            </div>
          </div>
          
          <div className="text-right">
            <p className="text-sm font-medium">{Math.round(progress.progress)}%</p>
        ...
        {isVideo && progress.qualityProgress && (
          <div className="space-y-2">
