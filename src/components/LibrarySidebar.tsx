  ...
  const Row = ({
    ...
    return (
      <div className="relative group">
        ...
        <Badge
          variant="secondary"
          className={`absolute top-[2px] right-1 rounded-full text-[10px] px-1.5 h-4 min-w-[16px] flex items-center justify-center pointer-events-none transition-all z-10 ${
            isSelected
