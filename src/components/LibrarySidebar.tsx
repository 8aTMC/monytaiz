...
export const LibrarySidebar = ({
  ...
  const Row = ({
    ...
    return (
      <div className="relative group">
        ...
        <Badge
          variant="secondary"
          className={`absolute top-0 right-0 rounded-full text-[10px] px-1.5 h-4 min-w-[16px] flex items-center justify-center pointer-events-none transition-all z-10 ${
            isSelected
  ...
  return (
    <div className="w-full flex-shrink-0 relative h-full border-r border-border" style={{ zIndex: 10 }}>
      ...
      <div className="relative h-full flex flex-col px-2 py-4" style={{ minWidth: '100%' }}>
