...
DROP FUNCTION IF EXISTS public.get_management_conversations();
DROP FUNCTION IF EXISTS public.get_user_conversations();

-- Recreate get_management_conversations function with avatar URL
...
-- Recreate get_user_conversations function with partner avatar URL  
